...
class FrontendAssetTests(unittest.TestCase):
    ...
    def test_invite_and_chat_activity_ui_is_wired(self) -> None:
        ...
        self.assertIn("registrationSubmitting", app_source)
        self.assertIn('classList.add("is-loading")', app_source)
        self.assertIn('result.sessionError', app_source)
    ...
    def test_recharge_credentials_and_fixed_products_are_wired(self) -> None:
        ...
        self.assertIn('data-recharge-amount="1"', html)
        ...
        self.assertIn('api("/api/recharge/orders"', app_source)
        self.assertIn("authenticatedApiUrl(result.order.qrCodeUrl)", app_source)
        self.assertNotIn("recharge.noteReminder", html)
